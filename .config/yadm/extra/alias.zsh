...
zi wait has'journalctl' atload'alias journalctl="journalctl --output cat --boot 0 --full"'
zi wait has'dmesg' atload'alias dmesg="dmesg --color=always | less"'
zi wait has'lsblk' atload'alias lsblk="lsblk -o name,label,fstype,uuid"'
